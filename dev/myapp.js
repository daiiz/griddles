...
myApp.load = function(e) {
   ...
   var arr = arr || [];
   arr.push({"wide": true, "id": "msg0", "type": "user-text", "dataset": [["hoge","hoge"]], "init": "Hello Griddles!", card: "#EEEE22", paddings: [26, 26, 26, 26]});
   ...
   arr.push({"wide": true, "id": "author1", "type": "user-caption-img", "dataset": [["hoge","hoge"]], "init": "https://identicons.github.com/40b2bcc96299804ade6b438e85a0bb0e.png", "card": "#fff", "caption": "Hello!", "caption_height_px": 30});
   arr.push({"id": "a0", "type": "user-caption-img", "dataset": [["hoge","hoge"]], "init": "sample-images/1.png", "card": false, "caption": "キャプション1（台紙なし）", "caption_height_px": 30, paddings: [0, 0, 0, 0]});
   ...
   arr.push({"wide": true, "id": "a10", "type": "user-img", "dataset": [["hoge","hoge"]], "init": "sample-images/11.png"});
